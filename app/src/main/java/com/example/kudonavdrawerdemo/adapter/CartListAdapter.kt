...
class CartListAdapter(
...
) : RecyclerView.Adapter<CartListAdapter.ProHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartListAdapter.ProHolder {
        val itemView =
    ...
    override fun onBindViewHolder(holder: CartListAdapter.ProHolder, position: Int) {
